...
typedef struct __attribute__((packed)) {
  ...
  uint16_t load : 9;   // Load in 0.1A (only 9 bits)
...
// Encrypted Data: DC/DC Converter Record (0x04)
typedef struct __attribute__((packed)) {
  uint8_t dev_state;
  uint8_t charger_error;
  int16_t in_voltage;  // Input voltage in 0.01V
  int16_t out_voltage; // Output voltage in 0.01V
  uint32_t offreason;  // Off reason
} victron_dcdc_t;

#if 0 // Unused
// OFF reasons (ORed)
  #define NO_INPUT 0x00000001
  #define OFF_SWITCH 0x00000002
  #define OFF_REGISTER 0x00000004
  #define REM_INPUT 0x00000008
  #define PROTECTION 0x00000010
  #define UNKNOWN1 0x00000020
  #define UNKNOWN2 0x00000040
  #define ENGINE_OFF 0x00000080
  #define UNKNOWN3 0x00000100
